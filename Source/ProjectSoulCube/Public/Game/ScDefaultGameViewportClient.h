...
#include "ScDefaultGameViewportClient.generated.h"

// Ref: https://unrealcommunity.wiki/global-fade-in-out-7mdoq5qd

/**
 * 
 */
UCLASS()
class PROJECTSOULCUBE_API UScDefaultGameViewportClient : public UCommonGameViewportClient
{
	GENERATED_BODY()
...
public:
	...
	virtual void Fade(const float InDuration, const bool InbToBlack);
